...
if [[ -f "/var/www/html/composer.lock" && ! -f "/var/www/html/public/media/js/frontend_routes.json" ]];then
...
if [[ ! -f "/var/www/html/composer.lock" ]];then
    ...
    echo "*"
    echo "* !!! WAIT FOR 'All files copied' message !!! "
    echo "* it can take some minutes..."
    echo "*"
    echo "*"
    echo "*"
    echo "*"
